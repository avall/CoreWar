...
import com.gmail.s0o3r0a4.corewar.net.node.core.Instruction.ADDR_MODE;
import com.gmail.s0o3r0a4.corewar.net.node.core.Instruction.MODIFIER;
import com.gmail.s0o3r0a4.corewar.net.node.core.Instruction.OP_CODE;
...
//    protected ArrayList<Instruction> warriorsCode[];
    ...
    protected Core(/*int playerNumber, */int coreSize) {
...
//        this.currentProcess = new Process(0, coreSize); // TODO: Add new constructor
    ...
    protected Core() {
        this.coreSize = 8000;
        this.core = new Instruction[this.coreSize];
    }
    ...
    protected void cycle() {
        if (maxWarrior > 0) {
            ...
            OP_CODE opCode = currentInstruction.getOpCode();
            MODIFIER modifier = currentInstruction.getModifier();
            ADDR_MODE modeA = currentInstruction.getModeA();
            int fieldA = currentInstruction.getFieldA();
            ADDR_MODE modeB = currentInstruction.getModeB();
            ...
            switch (opCode) {
                ...
                default:
                    // README: Not a in core operation
            }
