...
public class GameScreenDimensions {
    ...
    public static final float CORE_OFFSET_Y2 = 0f;
    public static final float CORE_COL_GAP = 1f;
    public static final float CORE_ROW_GAP = 1f;

    public static final float BLOCKS_COL = 16;
    public static final float BLOCKS_ROW = 500;
}
